...
function Update() {
  ...
  const readUser = async () => {
      await UserApi.readById(params.id)
          .then(res => {
  ...
  const submitHandler = async (e) => {
      e.preventDefault();
        try {
            ...
            await dispatch(userUpdate({ id: params.id, user }))
              .unwrap()
              .then(res => {
    ...
    <div className="container">
        <div className="row">
          <div className="col-md-12 text-center">
            <h6 className="display-6 text-dark">Update</h6>
          </div>
        </div>
                    ...
                    <form method="post" onSubmit={submitHandler} onReset={resetHandler}>
                        ...
                        <div className="form-group mt-2">
                              <button type='submit' className="btn btn-outline-success"> 
                                <i className="bi bi-plus-circle"></i> Update User</button>
